...
<div style='text-align: center; padding: 1rem;'>
    <h1 style='font-size: 2.5rem; color: red;'>🤖 AI Conversational <span style='color: red;'>Data Science</span> Tutor</h1>
...
with open(r"D:/Python_Challenges/Data Intern/genai.txt") as f:
